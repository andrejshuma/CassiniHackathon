        ...
        <div className="p-4 max-w-md mx-auto">
            ...
            <div className="bg-blue-50 rounded-3xl p-4 mb-4 shadow-md">
                ...
                <div className="bg-blue-50 rounded-3xl p-4 mb-4 shadow-md">
                    <div className="flex justify-between items-start mb-3">
                        <div className="flex items-center">
                            <div
                                className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden mr-4">
                                <svg viewBox="0 0 24 24" width="24" height="24" className="text-green-500">
                                    <path d="M22 12h-4l-3 9L9 3l-3 9H2" fill="none" stroke="currentColor"
                                          strokeWidth="2"
                                          strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </div>
                    ...
                    <div
                        className={`${getMentalHealthCategory(mentalHealthScore).bg} flex gap-6 items-center px-6 py-4 rounded-lg`}>
                    ...
                    <div className="bg-white rounded-lg p-3 text-sm border border-blue-100">
                        ...
                        <p className="text-gray-600">Try 5 minutes of mindful breathing to reduce stress and improve
                            your
                            focus for the day.</p>
                    </div>
                </div>
                                ...
                                <div className="bg-gray-100 rounded-3xl p-4 s shadow-md">
                                    <div className="w-10 h-10 mb-6 flex items-center justify-center">
                                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <line x1="12" y1="2" x2="12" y2="3.5" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                            <line x1="12" y1="20.5" x2="12" y2="22" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                            <line x1="2" y1="12" x2="3.5" y2="12" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                            <line x1="20.5" y1="12" x2="22" y2="12" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>


                                            <line x1="4.5" y1="4.5" x2="6" y2="6" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                            <line x1="18" y1="18" x2="19.5" y2="19.5" stroke="currentColor"
                                                  strokeWidth="1.5" strokeLinecap="round"/>
                                            <line x1="4.5" y1="19.5" x2="6" y2="18" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                            <line x1="18" y1="6" x2="19.5" y2="4.5" stroke="currentColor"
                                                  strokeWidth="1.5"
                                                  strokeLinecap="round"/>
                                        </svg>
                                    </div>
                            ...
                            <div className="bg-indigo-50 rounded-3xl p-4 mb-4 shadow-md">
                                ...
                                <div className="bg-white rounded-lg p-3 border border-indigo-100">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        <span className="font-medium">Suggestion:</span> Plan your outdoor activities
                                        for
